...
?>
	...
	<footer class="<?php echo $fclass; ?>" role="contentinfo">
		<div class="col-width">
			...
			<?php } else { ?>
				<?php printf( __( '%1$s, the %2$s theme for government.', 'govpress' ), 'Powered by <a href="https://govpress.govfresh.com/">GovPress</a>', '<a href="http://wordpress.org/">WordPress</a>' ); ?>
			<?php } ?>
		</div><!-- .col-width -->
	</footer><!-- .site-footer -->
</div><!-- #page -->
